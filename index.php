...
<!--                <a class="navbar-brand" href="#">  <img src="./img/logo.png" alt="logo">   </a>-->
         ...
         <li class="navbar-brand">
          <a class="nav-link" href="#"> <h4>Deepak Singh</h4> <span class="sr-only">(current)</span></a>
         </li>
  ...
  this.className += " active";
    ...
    <main class="site-main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 site-title">
                        ...
                        <h1 class="title-text text-uppercase"><p> I am Deepak</h1>
                        <h4 class="title-text text-uppercase">Computer Engineering Graduate</h4>
                        <h4 class="title-text text-uppercase">ML Intern @ Cloud-Counselage</h4>
                        <div class="site-buttons">
                            <div class="d-flex flex-row flex-wrap">
                                <button type="button" class="btn button primary-button mr-5 text-uppercase">hire
                                    me</button>
        ...
        <section class="about-area" id="about">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-15 about-title">
                        ...
                        <div class="paragraph py-4 w-75">
                            <p class="para">
                                Currently Deepak is a Computer-Engineering Student from Lokmanya Tilak College of Engineering(affiliated to M.U.). His background in Machine-Learning, Deep-Learning, and Back-End Development inform his mindful but competitive approach
                            </p>
                            <p class="para">
       ...
       ======================== End Brand Area ==============================  -->
        ...
        <section class="services-area" id="exp">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center services-title">
                        <h1 class="text-uppercase title-text">Work Experiences</h1>
                        <p class="para">
								Deepak has got work-experience as Intern with these esteemed organizations.
                        </p>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                <div class="sevices-img text-center py-4">
                                    <img src="https://media.glassdoor.com/sqlm/1975055/cloud-counselage-squarelogo-1562071517182.png" alt="Services-1">
                                </div>
                                <div class="card-body text-center">
                                    <h5 class="card-title text-uppercase font-roboto">ML Engineer</h5>
                                    <p class="card-text text-secondary">
                                        With Cloud Counselage, I have worked as an
                                        Machine Learning Engineer for tenure of 3 Months.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="project-area" id="project">
            <div class="container">
                <div class="project-title pb-5">
                  <center>  <h1 class="text-uppercase title-h1">Recently Done Project</h1> </center>
                        ...
                        <div class="our-project">
                            <div class="img">
                                <a class="test-popup-link" href="./img/portfolio/p1.jpg">
                                    <img src="./img/index.png" alt="portfolio-1" class="img-fluid">
                                </a>
                            </div>
                            <div class="title py-4">
                                <h4 class="text-uppercase">Text-To-Speech</h4>
                                <span class="text-secondary">Created, a project for capturing voice of user then converting it into
                                 text, and then processing that text and searching the result Online using API's.</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="our-project">
                            <div class="img">
                                <a class="test-popup-link" href="./img/portfolio/p2.jpg">
                                    <img src="./img/lib.PNG" alt="portfolio-2" class="img-fluid">
                                </a>
                            </div>
                            <div class="title py-4">
                                <h4 class="text-uppercase">Library System </h4>
                                <span class="text-secondary">Library Management System was created in Python.
                                Data was stored using FMS.</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item popular">
                        <div class="our-project">
                            <div class="img">
                                <a class="test-popup-link" href="./img/portfolio/p3.jpg">
                                    <img src="./img/index.jpeg" alt="portfolio-3" class="img-fluid">
                                </a>
                            </div>
                            <div class="title py-4">
            ...
            <div class="container subscribe">
                <div class="row">
                    <div class="col-lg-12 text-center subscribe-title">
                        ...
                        <p class="para">Want to stay updated with my Daily New Blogposts?<br> Subscribe to my NewsChannel. </p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="">
                ...
                <div class="copyrights text-center">
                    <p class="para">
                        Copyright ©2020 All rights reserved | This template is made with <span style="font-size:150%;color:red;">&hearts;</span> 
by
                        <a href="https://www.linkedin.com/in/deepak-singh-383760151/"><span style="color: var(--primary-color);">Deepak Singh</span></a>
                    </p>
                </div>
            </div>
        </div>
